...
namespace Lab3
{
    public class Provinces1Controller : Controller
    {
        ...
        // GET: Provinces1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Provinces1/Create
